...
# 定义模式变量
mode="sentence_relation_subject_fact_desc"

# 定义任务列表
declare -A tasks
tasks["mistral"]="dataset=train_$mode eval_path=test_$mode cache_path=autore/mistral/$mode/train eval_cache_path=autore/mistral/$mode/test output_dir_base=ckpt/mistral/$mode model_name_or_path=/workspace/xll/checkpoints/Mistral-7B-Instruct-v0.2 template=mistral learning_rate=5e-5 num_train_epochs=6.0"
