...
version="v0"
step="100"
paradigms="sentence_fact"
model_path="/workspace/xll/analysis_kg/public_code/train/LLaMA-Factory-main/ckpt/${MODEL_NAME}/${paradigms}_lr5e-5_deepspeed/checkpoint-${step}"

for dataset_name in "${!datasets[@]}"; do
  DATA_PATH="${datasets[$dataset_name]}"
  EVAL_SAVE_PATH="/workspace/xll/analysis_kg/public_code/train/LLaMA-Factory-main/result/${MODEL_NAME}/${paradigms}_lr5e-5_deepspeed/${dataset_name}_${step}/"
