...
# 为每个任务定义参数
task_params["chatglm3_fact"]="dataset=fact_train eval_path=fact_test cache_path=autore/chatglm3/fact/train eval_cache_path=autore/chatglm3/fact/test output_dir=ckpt/chatglm3/fact learning_rate=2e-4 save_steps=100 eval_steps=100 num_train_epochs=6 max_steps=4430"
