...
version="v5"
step="14200"
paradigms="sentence_relation_subject_fact_desc"
model_path="/workspace/xll/analysis_kg/public_code/train/LLaMA-Factory-main/ckpt/${MODEL_NAME}/${paradigms}_lr5e-5_gpu/checkpoint-${step}"


paradigms="relation"
for dataset_name in "${!datasets[@]}"; do
  DATA_PATH="${datasets[$dataset_name]}"
  EVAL_SAVE_PATH="/workspace/xll/analysis_kg/public_code/train/LLaMA-Factory-main/result/${MODEL_NAME}/${paradigms}_lr5e-5_gpu/${dataset_name}_${step}/"
